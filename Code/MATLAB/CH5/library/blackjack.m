function [State, Action, Reward] = blackjack(player_policy, ES_state, ES_action)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Blackjack game
% Input: 
%   1) Player's policy
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    while ~player_end
        if force_action
            ...
            player_action = player_policy(player_sum, dealer_show, player_usable_ace+1); % player makes a decision
        end
